      ...
      <div className="inline-block w-[75%] ">
        <div className="pr-8 pb-8 grid gap-4">
          ...
          <div className="bg-white rounded-lg px-12 py-12 text-center text-white border-[1px] border-gray-300 text-xl shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]">
            <div className="rounded-full p-6  bg-[#4ec6baab] text-black font-semibold text-2xl">
            ...
            />
            <div className="rounded-full p-6  bg-[#565656]">
            ...
            <div className="grid grid-cols-2 gap-10">
              ...
              <div className="col-span-1">
                <FontAwesomeIcon
                  ...
                  className="text-black py-6 text-4xl"
                />
                <div className="rounded-full p-6  bg-[#FF0000]">
              ...
              <div className="col-span-1">
                <FontAwesomeIcon
                  ...
                  className="text-black py-6 text-4xl"
                />
                <div className="rounded-full p-6  bg-[#548235]">
                ...
                <FontAwesomeIcon
                  ...
                  className="text-black py-6 text-4xl"
                />
                <div className="rounded-full p-6  bg-[#2e75b6]">
                ...
                <FontAwesomeIcon
                  ...
                  className="text-black py-6 text-4xl"
                />
                <div className="rounded-full p-6  bg-[#deb22e]">
                ...
                <FontAwesomeIcon
                  ...
                  className="text-black py-6 text-4xl"
                />
                <div className="rounded-full p-6  bg-[#767171]">
                ...
                <FontAwesomeIcon
                  ...
                  className="text-black py-6 text-4xl"
                />
                <div className="rounded-full p-6  bg-[#ff0066]">
