  ...
  return (
    <>
      <header className="flex flex-col justify-center items-center">
        <div className="w-full text-2xl sm:text-3xl pt-8 text-center font-bold text-blue-800 flex sm:px-12 sm:justify-between flex-col sm:flex-row justify-center items-center  ">
          <a href="#">
            <img
